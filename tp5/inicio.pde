class Inicio {
  ...
  void constTumbas() {
    if (estado== "jugar") {
      for (int i=0; i< tumbas.length; i++) {
        tumbas[i].dibujar();
        if (dist (personaje.returnX(), personaje.returnY(), tumbas[i].returnX(), tumbas[i].returnY())<= 10) {
          vida=-1;
          player2.play();
  ...
  void constCaramelos() {
    if (estado== "jugar") {
      for (int i=0; i< caramelos.length; i++) {
        ...
        if (dist (personaje.returnX(), personaje.returnY(), caramelos[i].returnX(), caramelos[i].returnY())<= 10) {
          puntos = +1;
        }
      }
    }
